 ...
 * It coordinates category and tutorial use cases and keeps a UI-facing state.
 *
...
const usePublishingStore = defineStore('publishing', () => {
    ...
    /**
     * Creates a category through infrastructure and appends it to the local state.
    ...
    /**
     * Deletes a tutorial and removes it from the local state.
